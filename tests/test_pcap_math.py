...
class TestPcapMath(unittest.TestCase):
    ...
    def test_intersect_pcap(self):
        ...
        intersect_pcap('examples/simul1.pcap',
                       'examples/simul2.pcap')
        self.assertFalse(filecmp.cmp('intersect.pcap', 'examples/set_ops/'
                                     'intersect.pcap'))
    ...
    def test_difference_pcap(self):
        ...
        difference_pcap('examples/simul1.pcap',
                        'examples/simul3.pcap')
        # The generated file should be the same as examples/union.pcap
        self.assertTrue(filecmp.cmp('difference.pcap', 'examples/set_ops/'
    ...
    def test_get_minmax_common_frames(self):
        ...
        min_frame = '881544abbfdd2477035113440800450000547baf40004001922a0a30' \
                    '1290080808080800ae46628b0001e830ab5b0000000088cd0c000000' \
                    '0000101112131415161718191a1b1c1d1e1f20212223242526272829' \
                    '2a2b2c2d2e2f3031323334353637'
        max_frame = '247703511344881544abbfdd0800452000542bbc00007901e8fd0808' \
                    '08080a301290000082a563110001f930ab5b00000000a9e80d000000' \
                    '0000101112131415161718191a1b1c1d1e1f20212223242526272829' \
                    '2a2b2c2d2e2f3031323334353637'
        pcap_list = ['examples/simul1.pcap',
                     'examples/simul2.pcap',
                     'examples/simul3.pcap']
